...
namespace Neuron
{
    public class NeuronSource
    {
        ...
        public int numOfActiveActors
        {
            get { return activeActors.Count; }
        }

        public int numOfSuspendedActors
        {
            get { return suspendedActors.Count; }
        }

        public int referenceCounter { get; private set; }

        public NeuronSource(string address, int port, int commandServerPort, NeuronConnection.SocketType socketType,
            IntPtr socketReference, IntPtr commandSocketReference)
        {
