...
namespace Neuron
{
    ...
    public class NeuronActor
    {
        ...
        {
            get { return header.DataVersion; }
        }

        public string name
        {
            get { return header.AvatarName; }
        }

        public int index
        {
            get { return (int) header.AvatarIndex; }
        }

        public bool withDisplacement
        {
            get { return header.bWithDisp != 0; }
        }

        public bool withReference
        {
            get { return header.bWithReference != 0; }
        }

        public int dataCount
        {
            get { return (int) header.DataCount; }
        }
...
//				Debug.Log("header::" + header.DataCount + "," + header.FrameIndex + ",name "+header.AvatarName);
        ...
        {
            return DateTime.Now.Hour * 3600 * 1000 + DateTime.Now.Minute * 60 * 1000 + DateTime.Now.Second * 1000 +
